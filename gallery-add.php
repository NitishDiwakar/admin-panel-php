...
<a href="gallery.php" class="btn btn-primary pull-right"><i class="fa fa-picture-o"></i> Gallery</a>
 ...
 <form action="upload.php" class="dropzone well" id="my-dropzone">
 	<div class="row">
 ...
 <!-- <a href="gallery.php" class="btn btn-primary">Go back</a> -->
	<center>
		<button class="btn btn-success btn-lg" id="submit-all">Submit all files</button>
	</center>
								</div>
