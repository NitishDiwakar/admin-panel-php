...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Blog Category - Ace Admin</title>
...
<table id="example" class="table table-striped table-bordered table-hover"> 
          ...
          ?>
            <tr>
              ...
              <td>
              <a href="blog-category-edit.php?id=<?php echo $row['cat_id']; ?>" class="btn btn-primary" title="edit"><i class="fa fa-edit" aria-hidden="true"></i></a>
              <a href="include/blog-cat-delete.php?id=<?php echo $row['cat_id']; ?>" onclick="return confirm('Are you sure?')" class="btn btn-danger" title="delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
              </td>
            </tr>
            <?php  
            $count++;
